  ...
  React.useEffect(() => {
    ...
    if (account) {
      ...
      void getAccountSecret(account.id)
        .then((secret) => setCredential(secret.credential))
  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 w-[min(420px,calc(100%-2rem))] -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-surface p-5 shadow-xl ring-1 ring-black/10">

...
export const THEME_COLOR_ROLES = [
  ...
  "toolbarControlHover",
  "surface",
  /** Settings chrome, popovers, and dropdowns — independent of card `surface`. */
  "menu",
  "surfaceRaised",
  "surfaceOverlay",
  "text",
...
export const T3_CHAT_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    menu: "oklch(0.971835 0.012884 321.894)",
  ...
  variants: {
    dark: {
      ...
      menu: "oklch(0.267101 0.02016 311.799)",
...
export const GROVE_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    menu: "oklch(0.972369 0.005497 157.15)",
  ...
  variants: {
    dark: {
      ...
      menu: "oklch(0.260865 0.02152 162.75)",
...
export const OCEAN_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    menu: "oklch(0.974199 0.002856 241.597)",
  ...
  variants: {
    dark: {
      ...
      menu: "oklch(0.242641 0.024125 250.573)",
...
export const EMBER_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    menu: "oklch(0.976527 0.002685 60.725)",
  ...
  variants: {
    dark: {
      ...
      menu: "oklch(0.245899 0.019144 42.044)",
...
export const IRIS_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    menu: "oklch(0.976531 0.003855 303.226)",
  ...
  variants: {
    dark: {
      ...
      menu: "oklch(0.225975 0.031062 293.741)",

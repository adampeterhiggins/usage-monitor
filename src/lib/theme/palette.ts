...
export const CUSTOM_THEMES_STORAGE_KEY = "usage-monitor:themes:v1";
export const THEME_FOLLOW_SYSTEM_STORAGE_KEY = "usage-monitor:theme-follow-system";
export const THEME_APPEARANCE_MODE_STORAGE_KEY = "usage-monitor:theme-appearance-mode";
export const THEME_HALVES_STORAGE_KEY = "usage-monitor:theme-halves:v1";
...
export class ThemeLibraryStorageError extends Error {
  ...
  constructor(input: {
    ...
    const direction = input.operation === "read" ? "from" : "to";
    super(`Failed to ${input.operation} the theme library ${direction} ${input.storageKey}.`);
...
export const isThemeLibraryStorageError = (error: unknown): error is ThemeLibraryStorageError =>
  error instanceof ThemeLibraryStorageError;
